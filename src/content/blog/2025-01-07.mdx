...
pubDate: 'Jan 05 2025'
heroImage: '../../assets/images/posts/2025-01-07/title/index.mini.svg'
tags:
...
There is the [Github Repository](https://github.com/gaomingzhao666/nano-blog) and the [Demo Website](https://nano-blog-nine.vercel.app).
...
### Clone the Template from Github - Recommend
...
### Create a new Project with the Template by Astro cli
...
<Alert>
  Be notice that you can only use components in the `mdx` files.
</Alert>
