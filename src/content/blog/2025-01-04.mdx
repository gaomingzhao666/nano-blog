---
title: 'Build and Deploy an Modern Dev Portfolio in 10 mins'
description: 'Step by step guide for Learn how to build and deploy a modern developer portfolio in a fastest way by using a open-source template.'
pubDate: 'Jan 04 2025'
...
<Image
  src={indexImage}
  format="png"
  class="rounded-xl border shadow dark:ring-1"
...
<Alert>
  Be notice that the nano-portfolio have a comment system that build by mongodb have not configured yet.
</Alert>
